  ...
  <SectionWrapper id="home" className="min-h-screen flex items-center pt-24">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      <FadeIn delay={200} className="space-y-8 order-2 md:order-1">
        ...
        <h1 className="font-serif text-7xl md:text-8xl text-mocha-900 leading-[0.9]">Gentle <br /><span className="italic font-light text-mocha-500">Beauty</span> For Everyday.</h1>
        <p className="font-body text-mocha-500 text-lg max-w-md">The art of Asian floral arrangement, bringing the breath of nature into your living space.</p>
        <div className="flex gap-4">
          <Button onClick={onShopClick}>Shop Now</Button>
          <Button variant="text">About Lamie</Button>
        </div>
      </FadeIn>
      <FadeIn delay={400} className="relative flex justify-center order-1 md:order-2">
        ...
        <div className="absolute -bottom-8 -right-4 w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-lg border border-cream-200 animate-float">
           <div className="text-center">
              ...
              <span className="block text-[8px] uppercase tracking-widest text-mocha-300">Fresh</span>
           </div>
        </div>
      </FadeIn>
    </div>
